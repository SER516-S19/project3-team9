...
/**
 * Class that generates a list of names for all quizzes saved in the quizzes
 * folder. Returns a list containing only JSON quiz files.
 *
...
public class QuizList {
	...
	/**
	 * When called, generates a list of quizzes that are saved as JSON files in the
	 * quizzes folder. Doesn't include the ".json" at the end of the file name.
	 * 
